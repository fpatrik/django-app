...
function api_get_options(q){
    ...
    xmlHttp.open("GET", 'https://app.conventec.ch/api?t=search&q=' + q, false); // false for synchronous request
    xmlHttp.send(null);
...
function api_get_selection(q){
    var xmlHttp = new XMLHttpRequest();
    xmlHttp.open("GET", 'https://app.conventec.ch/api?t=uid&q=' + q, false); // false for synchronous request
    xmlHttp.send(null);
    return xmlHttp.responseText;
}

function reset_shares(){
	return {'namen_stamm' : {'value' : 0}, 
...
api = {'query' : '', 'options' : [], 'chose_only' : '3', 'message' : {'message' : 'Bitte Firmenname eingeben.', 'type' : 'info'}, 
       ...
       'get_selection' : function(q){
    	   ...
    	   if(result.status == 'success'){
               ...
               // Get verwaltungsrats
               variables['angaben']['verwaltungsrat'] = [];
                ...
                var total_value = 0;
    	   		for(var i = 0; i < data.shares.length; i++){
    	   			...
    	   			if(share.typ == 'Namenaktien'){
                        ...
                        total_value = total_value + parseFloat(share.price) * parseFloat(share.anzahl);
    	   			}
               ...
               shares['total_value'] = total_value;
    	       variables['eroffnungen']['aktien']['namenaktien_stammaktien_n'] = 0;
               variables['eroffnungen']['aktien_v']['namenaktien_stammaktien_n'] = 0;
               variables['eroffnungen']['aktien_d']['namenaktien_stammaktien_n'] = 0;
               variables['eroffnungen']['aktien']['namenaktien_stimmrechtsaktien_n'] = 0;
               variables['eroffnungen']['aktien_v']['namenaktien_stimmrechtsaktien_n'] = 0;
               variables['eroffnungen']['aktien_d']['namenaktien_stimmrechtsaktien_n'] = 0;
               variables['eroffnungen']['aktien']['inhaberaktien_stammaktien_n'] = 0;
               variables['eroffnungen']['aktien_v']['inhaberaktien_stammaktien_n'] = 0;
               variables['eroffnungen']['aktien_d']['inhaberaktien_stammaktien_n'] = 0;
                
    	       if(shares.namen_vorzug_1.name != ''){
                    ...
                    variables['eroffnungen']['aktien']['namenaktien_vorzugsaktien_kat1_bezeichnung'] = '';
    	   			variables['eroffnungen']['aktien_v']['namenaktien_vorzugsaktien_kat1_bezeichnung'] = '';
    	   			variables['eroffnungen']['aktien_d']['namenaktien_vorzugsaktien_kat1_bezeichnung'] = '';
                    variables['eroffnungen']['aktien']['namenaktien_vorzugsaktien_kat1_n'] = 0;
    	   			variables['eroffnungen']['aktien_v']['namenaktien_vorzugsaktien_kat1_n'] = 0;
    	   			variables['eroffnungen']['aktien_d']['namenaktien_vorzugsaktien_kat1_n'] = 0;
               }
    	   		
    	   		if(shares.namen_vorzug_2.name != ''){
                   ...
                   variables['eroffnungen']['aktien']['namenaktien_vorzugsaktien_kat2_bezeichnung'] = '';
    	   			variables['eroffnungen']['aktien_v']['namenaktien_vorzugsaktien_kat2_bezeichnung'] = '';
    	   			variables['eroffnungen']['aktien_d']['namenaktien_vorzugsaktien_kat2_bezeichnung'] = '';
                   variables['eroffnungen']['aktien']['namenaktien_vorzugsaktien_kat2_n'] = 0;
    	   			variables['eroffnungen']['aktien_v']['namenaktien_vorzugsaktien_kat2_n'] = 0;
    	   			variables['eroffnungen']['aktien_d']['namenaktien_vorzugsaktien_kat2_n'] = 0;
               }
    	   		
    	   		if(shares.namen_vorzug_3.name != ''){
                   ...
                   variables['eroffnungen']['aktien']['namenaktien_vorzugsaktien_kat3_bezeichnung'] = '';
    	   			variables['eroffnungen']['aktien_v']['namenaktien_vorzugsaktien_kat3_bezeichnung'] = '';
    	   			variables['eroffnungen']['aktien_d']['namenaktien_vorzugsaktien_kat3_bezeichnung'] = '';
                   variables['eroffnungen']['aktien']['namenaktien_vorzugsaktien_kat3_n'] = 0;
    	   			variables['eroffnungen']['aktien_v']['namenaktien_vorzugsaktien_kat3_n'] = 0;
    	   			variables['eroffnungen']['aktien_d']['namenaktien_vorzugsaktien_kat3_n'] = 0;
               }
    	   		
    	   		if(shares.inhaber_vorzug_1.name != ''){
                   ...
                   variables['eroffnungen']['aktien']['inhaberaktien_vorzugsaktien_kat1_bezeichnung'] = '';
    	   			variables['eroffnungen']['aktien_v']['inhaberaktien_vorzugsaktien_kat1_bezeichnung'] = '';
    	   			variables['eroffnungen']['aktien_d']['inhaberaktien_vorzugsaktien_kat1_bezeichnung'] = '';
                   variables['eroffnungen']['aktien']['inhaberaktien_vorzugsaktien_kat1_n'] = 0;
    	   			variables['eroffnungen']['aktien_v']['inhaberaktien_vorzugsaktien_kat1_n'] = 0;
    	   			variables['eroffnungen']['aktien_d']['inhaberaktien_vorzugsaktien_kat1_n'] = 0;
               }
    	   		
    	   		if(shares.inhaber_vorzug_2.name != ''){
    	   			variables['eroffnungen']['aktien']['inhaberaktien_vorzugsaktien_kat2_bezeichnung'] = shares.inhaber_vorzug_2.name;
    	   			variables['eroffnungen']['aktien_v']['inhaberaktien_vorzugsaktien_kat2_bezeichnung'] = shares.inhaber_vorzug_2.name;
    	   			variables['eroffnungen']['aktien_d']['inhaberaktien_vorzugsaktien_kat2_bezeichnung'] = shares.inhaber_vorzug_2.name;
    	   		}
               else{
                   variables['eroffnungen']['aktien']['inhaberaktien_vorzugsaktien_kat2_bezeichnung'] = '';
    	   			variables['eroffnungen']['aktien_v']['inhaberaktien_vorzugsaktien_kat2_bezeichnung'] = '';
    	   			variables['eroffnungen']['aktien_d']['inhaberaktien_vorzugsaktien_kat2_bezeichnung'] = '';
                   variables['eroffnungen']['aktien']['inhaberaktien_vorzugsaktien_kat2_n'] = 0;
    	   			variables['eroffnungen']['aktien_v']['inhaberaktien_vorzugsaktien_kat2_n'] = 0;
    	   			variables['eroffnungen']['aktien_d']['inhaberaktien_vorzugsaktien_kat2_n'] = 0;
               }
    	   		
    	   		if(shares.inhaber_vorzug_3.name != ''){
    	   			variables['eroffnungen']['aktien']['inhaberaktien_vorzugsaktien_kat3_bezeichnung'] = shares.inhaber_vorzug_3.name;
    	   			variables['eroffnungen']['aktien_v']['inhaberaktien_vorzugsaktien_kat3_bezeichnung'] = shares.inhaber_vorzug_3.name;
    	   			variables['eroffnungen']['aktien_d']['inhaberaktien_vorzugsaktien_kat3_bezeichnung'] = shares.inhaber_vorzug_3.name;
    	   		}
               else{
                   variables['eroffnungen']['aktien']['inhaberaktien_vorzugsaktien_kat3_bezeichnung'] = '';
    	   			variables['eroffnungen']['aktien_v']['inhaberaktien_vorzugsaktien_kat3_bezeichnung'] = '';
    	   			variables['eroffnungen']['aktien_d']['inhaberaktien_vorzugsaktien_kat3_bezeichnung'] = '';
                   variables['eroffnungen']['aktien']['inhaberaktien_vorzugsaktien_kat3_n'] = 0;
    	   			variables['eroffnungen']['aktien_v']['inhaberaktien_vorzugsaktien_kat3_n'] = 0;
    	   			variables['eroffnungen']['aktien_d']['inhaberaktien_vorzugsaktien_kat3_n'] = 0;
               }
               
                variables['shares'] = shares;
    	   		
    	   		var cantons = [{'name' : '350', 'de' : 'Graubünden', 'en' : 'Graubunden'}, {'name' : '20', 'de' : 'Zürich', 'en' : 'Zurich'}, {'name' : 'ZG', 'de' : 'Zug', 'en' : 'Zug'}, {'name' : 'LU', 'de' : 'Luzern', 'en' : 'Lucerne'}, {'name' : 'BS', 'de' : 'Basel', 'en' : 'Basel'}];
    	   		
    	   		for(var i = 0; i < cantons.length; i++){
    	   			if(cantons[i].name == data.registerOfficeId){
...
function aktionare_sex(){
	if(variables['aktionare']['aktionar'].length > 1){
		...
		var zahl = 's';
        if(variables['aktionare']['aktionar'][0].typ == 'gesellschaft'){
            return 'cs';
        }
	}
	for(var i = 0; i < variables['aktionare']['aktionar'].length; i++){
		if(variables['aktionare']['aktionar'][i]['typ'] == 'person' && variables['aktionare']['aktionar'][i]['sex'] == 'herr'){
			if(zahl == 's'){
				return 'ms'
			}
			else{
...
form = new Form({'title' : function(){return 'Muss ich noch ändern!'}, 'debug' : true});
...
var checkbox = checkbox_group.add_checkbox({'label' : function(){if(typeof variables['verzicht']['notar']['kanton'] != 'undefined' && variables['verzicht']['notar']['kanton'] == 'zug'){return 'Vewaltungsräte unterzeichnen Handelsregisteranmeldung ausserhalb Notariat';}else{return 'Vewaltungsräte unterzeichnen Handelsregisteranmeldung ausserhalb Amtslokal';}}, 'variable_name' : 'vewaltungsrate'});
...
form.add_derived_variable({'condition' : function(v){if(v[0] == 'verzicht'){return true}else{return false}}, 'assignment' : function(){
    if(typeof variables['verzicht']['ausfertigungen']['urkundsperson'] != 'undefined'){
        variables['verzicht']['ausfertigungen']['urkundsperson_n'] = parseInt(variables['verzicht']['ausfertigungen']['urkundsperson'].replace(/[^0-9]/, ''));
    }
    if(typeof variables['verzicht']['ausfertigungen']['handelsregisteramt'] != 'undefined'){
    ...
    if(typeof variables['verzicht']['ausfertigungen']['gesellschaft'] != 'undefined'){
        variables['verzicht']['ausfertigungen']['gesellschaft_n'] = parseInt(variables['verzicht']['ausfertigungen']['gesellschaft'].replace(/[^0-9]/, ''));
    }
    if(typeof variables['verzicht']['ausfertigungen']['revisionsstelle'] != 'undefined'){
...
var option = radio.add_option({'value' : 'notariat', 'label' : 'im Notariat', 'show' : function(){return equals(['verzicht', 'verzicht', 'erforderlich'], 'erforderlich')}});
...
var text = page0.add_text({'label' : 'Land (Deutsch)', 'variable_name' : 'land_de', 'required' : true, 'show' : function(){return (equals(['eroffnungen', 'datum', 'ort'], 'juristisch') || equals(['eroffnungen', 'datum', 'ort'], 'naturlich'))}});

var text = page0.add_text({'label' : 'Land (Englisch)', 'variable_name' : 'land_en', 'required' : true, 'show' : function(){return (equals(['eroffnungen', 'datum', 'ort'], 'juristisch') || equals(['eroffnungen', 'datum', 'ort'], 'naturlich'))}});
...
var text = page1.add_text({'label' : 'Land (Deutsch)', 'variable_name' : 'land_de', 'required' : true, 'show' : function(){return equals(['eroffnungen', 'vorsitzender', 'ausland'], true)}});

var text = page1.add_text({'label' : 'Land (Englisch)', 'variable_name' : 'land_en', 'required' : true, 'show' : function(){return equals(['eroffnungen', 'vorsitzender', 'ausland'], true)}});
...
var text = page3.add_text({'label' : 'Anzahl', 'variable_name' : 'anzahl_d', 'show' : function(){if(equals(['eroffnungen', 'vertretung', 'geschlecht_d'], 'weiblich_p') || equals(['eroffnungen', 'vertretung', 'geschlecht_d'], 'mannlich_p')){return true;}else{return false;}}});
...
var label = page4.add_label({'label' : 'Namenaktien', 'font_size' : function(self){return '18'}, 'show' : function(){if(variables['shares'].namen_stamm.value != 0 || variables['shares'].namen_stimm.value != 0 || variables['shares'].namen_vorzug_1.value != 0){return true;}else{return false;}}});

var label = page4.add_label({'label' : 'Stammaktien', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].namen_stamm.value != 0){return true;}else{return false;}}});

var text = page4.add_text({'label' : 'Anzahl Stammaktien', 'variable_name' : 'namenaktien_stammaktien_n', 'show' : function(){if(variables['shares'].namen_stamm.value != 0){return true;}else{return false;}}});
form.add_derived_variable({'condition' : function(v){if(v[0] == 'eroffnungen' && v[1] == 'aktien' && v[2] == 'namenaktien_stammaktien_n'){return true}else{return false}}, 'assignment' : function(v){
    variables[v[0]][v[1]][v[2]] = parseInt(variables[v[0]][v[1]][v[2]].replace(/[^0-9]/, ''));variables[v[0]][v[1]]['namenaktien_stammaktien'] = (parseFloat(variables[v[0]][v[1]][v[2]]) * variables['shares'].namen_stamm.value).toFixed(2);}});

var text = page4.add_text({'label' : 'Nominalwert Stammaktien (CHF)', 'variable_name' : 'namenaktien_stammaktien', 'show' : function(){if(variables['shares'].namen_stamm.value != 0){return true;}else{return false;}}});
...
var label = page4.add_label({'label' : 'Vorzugsaktien Kategorie 1', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].namen_vorzug_1.value != 0){return true;}else{return false;}}});

var text = page4.add_text({'label' : 'Anzahl', 'variable_name' : 'namenaktien_vorzugsaktien_kat1_n', 'show' : function(){if(variables['shares'].namen_vorzug_1.value != 0){return true;}else{return false;}}});
form.add_derived_variable({'condition' : function(v){if(v[0] == 'eroffnungen' && v[1] == 'aktien' && v[2] == 'namenaktien_vorzugsaktien_kat1_n'){return true}else{return false}}, 'assignment' : function(v){
    variables[v[0]][v[1]][v[2]] = parseInt(variables[v[0]][v[1]][v[2]].replace(/[^0-9]/, ''));variables[v[0]][v[1]]['namenaktien_vorzugsaktien_kat1'] = (parseFloat(variables[v[0]][v[1]][v[2]]) * variables['shares'].namen_vorzug_1.value).toFixed(2);}});

var text = page4.add_text({'label' : 'Bezeichnung', 'variable_name' : 'namenaktien_vorzugsaktien_kat1_bezeichnung', 'show' : function(){if(variables['shares'].namen_vorzug_1.value != 0){return true;}else{return false;}}});

var text = page4.add_text({'label' : 'Nominalwert (CHF)', 'variable_name' : 'namenaktien_vorzugsaktien_kat1', 'show' : function(){if(variables['shares'].namen_vorzug_1.value != 0){return true;}else{return false;}}});
...
var label = page4.add_label({'label' : 'Vorzugsaktien Kategorie 2', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].namen_vorzug_2.value != 0){return true;}else{return false;}}});

var text = page4.add_text({'label' : 'Anzahl', 'variable_name' : 'namenaktien_vorzugsaktien_kat2_n', 'show' : function(){if(variables['shares'].namen_vorzug_2.value != 0){return true;}else{return false;}}});
form.add_derived_variable({'condition' : function(v){if(v[0] == 'eroffnungen' && v[1] == 'aktien' && v[2] == 'namenaktien_vorzugsaktien_kat2_n'){return true}else{return false}}, 'assignment' : function(v){
    variables[v[0]][v[1]][v[2]] = parseInt(variables[v[0]][v[1]][v[2]].replace(/[^0-9]/, ''));variables[v[0]][v[1]]['namenaktien_vorzugsaktien_kat2'] = (parseFloat(variables[v[0]][v[1]][v[2]]) * variables['shares'].namen_vorzug_2.value).toFixed(2);}});

var text = page4.add_text({'label' : 'Bezeichnung', 'variable_name' : 'namenaktien_vorzugsaktien_kat2_bezeichnung', 'show' : function(){if(variables['shares'].namen_vorzug_2.value != 0){return true;}else{return false;}}});

var text = page4.add_text({'label' : 'Nominalwert (CHF)', 'variable_name' : 'namenaktien_vorzugsaktien_kat2', 'show' : function(){if(variables['shares'].namen_vorzug_2.value != 0){return true;}else{return false;}}});
...
var label = page4.add_label({'label' : 'Vorzugsaktien Kategorie 3', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].namen_vorzug_3.value != 0){return true;}else{return false;}}});

var text = page4.add_text({'label' : 'Anzahl', 'variable_name' : 'namenaktien_vorzugsaktien_kat3_n', 'show' : function(){if(variables['shares'].namen_vorzug_3.value != 0){return true;}else{return false;}}});
form.add_derived_variable({'condition' : function(v){if(v[0] == 'eroffnungen' && v[1] == 'aktien' && v[2] == 'namenaktien_vorzugsaktien_kat3_n'){return true}else{return false}}, 'assignment' : function(v){
    variables[v[0]][v[1]][v[2]] = parseInt(variables[v[0]][v[1]][v[2]].replace(/[^0-9]/, ''));variables[v[0]][v[1]]['namenaktien_vorzugsaktien_kat3'] = (parseFloat(variables[v[0]][v[1]][v[2]]) * variables['shares'].namen_vorzug_3.value).toFixed(2);}});

var text = page4.add_text({'label' : 'Bezeichnung', 'variable_name' : 'namenaktien_vorzugsaktien_kat3_bezeichnung', 'show' : function(){if(variables['shares'].namen_vorzug_3.value != 0){return true;}else{return false;}}});

var text = page4.add_text({'label' : 'Nominalwert (CHF)', 'variable_name' : 'namenaktien_vorzugsaktien_kat3', 'show' : function(){if(variables['shares'].namen_vorzug_3.value != 0){return true;}else{return false;}}});
...
var label = page4.add_label({'label' : 'Stimmrechtsaktien', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].namen_stimm.value != 0){return true;}else{return false;}}});

var text = page4.add_text({'label' : 'Anzahl Stimmrechtsaktien', 'variable_name' : 'namenaktien_stimmrechtsaktien_n', 'show' : function(){if(variables['shares'].namen_stimm.value != 0){return true;}else{return false;}}});
form.add_derived_variable({'condition' : function(v){if(v[0] == 'eroffnungen' && v[1] == 'aktien' && v[2] == 'namenaktien_stimmrechtsaktien_n'){return true}else{return false}}, 'assignment' : function(v){
    variables[v[0]][v[1]][v[2]] = parseInt(variables[v[0]][v[1]][v[2]].replace(/[^0-9]/, ''));variables[v[0]][v[1]]['namenaktien_stimmrechtsaktien'] = (parseFloat(variables[v[0]][v[1]][v[2]]) * variables['shares'].namen_stimm.value).toFixed(2);}});

var text = page4.add_text({'label' : 'Nominalwert Stimmrechtsaktien (CHF)', 'variable_name' : 'namenaktien_stimmrechtsaktien', 'show' : function(){if(variables['shares'].namen_stimm.value != 0){return true;}else{return false;}}});
...
var separator = page4.add_separator({'show' : function(){if((variables['shares'].namen_stamm.value != 0 || variables['shares'].namen_stimm.value != 0 || variables['shares'].namen_vorzug_1.value != 0 || variables['shares'].namen_vorzug_2.value != 0 || variables['shares'].namen_vorzug_3.value != 0) && (variables['shares'].inhaber_stamm.value != 0 || variables['shares'].inhaber_vorzug_1.value != 0 || variables['shares'].inhaber_vorzug_2.value != 0 || variables['shares'].inhaber_vorzug_3.value != 0)){return true;}else{return false;}}});

var label = page4.add_label({'label' : 'Inhaberaktien', 'font_size' : function(self){return '18'}, 'show' : function(){if(variables['shares'].inhaber_stamm.value != 0 || variables['shares'].inhaber_vorzug_1.value != 0 || variables['shares'].inhaber_vorzug_2.value != 0 || variables['shares'].inhaber_vorzug_3.value != 0){return true;}else{return false;}}});

var label = page4.add_label({'label' : 'Stammaktien', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].inhaber_stamm.value != 0){return true;}else{return false;}}});

var text = page4.add_text({'label' : 'Anzahl Stammaktien', 'variable_name' : 'inhaberaktien_stammaktien_n', 'show' : function(){if(variables['shares'].inhaber_stamm.value != 0){return true;}else{return false;}}});
form.add_derived_variable({'condition' : function(v){if(v[0] == 'eroffnungen' && v[1] == 'aktien' && v[2] == 'inhaberaktien_stammaktien_n'){return true}else{return false}}, 'assignment' : function(v){
    variables[v[0]][v[1]][v[2]] = parseInt(variables[v[0]][v[1]][v[2]].replace(/[^0-9]/, ''));variables[v[0]][v[1]]['inhaberaktien_stammaktien'] = (parseFloat(variables[v[0]][v[1]][v[2]]) * variables['shares'].inhaber_stamm.value).toFixed(2);}});

var text = page4.add_text({'label' : 'Nominalwert Stammaktien (CHF)', 'variable_name' : 'inhaberaktien_stammaktien', 'show' : function(){if(variables['shares'].inhaber_stamm.value != 0){return true;}else{return false;}}});
...
var label = page4.add_label({'label' : 'Vorzugsaktien Kategorie 1', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].inhaber_vorzug_1.value != 0){return true;}else{return false;}}});

var text = page4.add_text({'label' : 'Anzahl', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat1_n', 'show' : function(){if(variables['shares'].inhaber_vorzug_1.value != 0){return true;}else{return false;}}});
form.add_derived_variable({'condition' : function(v){if(v[0] == 'eroffnungen' && v[1] == 'aktien' && v[2] == 'inhaberaktien_vorzugsaktien_kat1_n'){return true}else{return false}}, 'assignment' : function(v){
    variables[v[0]][v[1]][v[2]] = parseInt(variables[v[0]][v[1]][v[2]].replace(/[^0-9]/, ''));variables[v[0]][v[1]]['inhaberaktien_vorzugsaktien_kat1'] = (parseFloat(variables[v[0]][v[1]][v[2]]) * variables['shares'].inhaber_vorzug_1.value).toFixed(2);}});

var text = page4.add_text({'label' : 'Bezeichnung', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat1_bezeichnung', 'show' : function(){if(variables['shares'].inhaber_vorzug_1.value != 0){return true;}else{return false;}}});

var text = page4.add_text({'label' : 'Nominalwert (CHF)', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat1', 'show' : function(){if(variables['shares'].inhaber_vorzug_1.value != 0){return true;}else{return false;}}});
...
var label = page4.add_label({'label' : 'Vorzugsaktien Kategorie 2', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].inhaber_vorzug_2.value != 0){return true;}else{return false;}}});

var text = page4.add_text({'label' : 'Anzahl', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat2_n', 'show' : function(){if(variables['shares'].inhaber_vorzug_2.value != 0){return true;}else{return false;}}});
form.add_derived_variable({'condition' : function(v){if(v[0] == 'eroffnungen' && v[1] == 'aktien' && v[2] == 'inhaberaktien_vorzugsaktien_kat2_n'){return true}else{return false}}, 'assignment' : function(v){
    variables[v[0]][v[1]][v[2]] = parseInt(variables[v[0]][v[1]][v[2]].replace(/[^0-9]/, ''));variables[v[0]][v[1]]['inhaberaktien_vorzugsaktien_kat2'] = (parseFloat(variables[v[0]][v[1]][v[2]]) * variables['shares'].inhaber_vorzug_2.value).toFixed(2);}});

var text = page4.add_text({'label' : 'Bezeichnung', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat2_bezeichnung', 'show' : function(){if(variables['shares'].inhaber_vorzug_2.value != 0){return true;}else{return false;}}});

var text = page4.add_text({'label' : 'Nominalwert (CHF)', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat2', 'show' : function(){if(variables['shares'].inhaber_vorzug_2.value != 0){return true;}else{return false;}}});
...
var label = page4.add_label({'label' : 'Vorzugsaktien Kategorie 3', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].inhaber_vorzug_3.value != 0){return true;}else{return false;}}});

var text = page4.add_text({'label' : 'Anzahl', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat3_n', 'show' : function(){if(variables['shares'].inhaber_vorzug_3.value != 0){return true;}else{return false;}}});
form.add_derived_variable({'condition' : function(v){if(v[0] == 'eroffnungen' && v[1] == 'aktien' && v[2] == 'inhaberaktien_vorzugsaktien_kat3_n'){return true}else{return false}}, 'assignment' : function(v){
    variables[v[0]][v[1]][v[2]] = parseInt(variables[v[0]][v[1]][v[2]].replace(/[^0-9]/, ''));variables[v[0]][v[1]]['inhaberaktien_vorzugsaktien_kat3'] = (parseFloat(variables[v[0]][v[1]][v[2]]) * variables['shares'].inhaber_vorzug_3.value).toFixed(2);}});

var text = page4.add_text({'label' : 'Bezeichnung', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat3_bezeichnung', 'show' : function(){if(variables['shares'].inhaber_vorzug_3.value != 0){return true;}else{return false;}}});

var text = page4.add_text({'label' : 'Nominalwert (CHF)', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat3', 'show' : function(){if(variables['shares'].inhaber_vorzug_3.value != 0){return true;}else{return false;}}});
...
var label = page5.add_label({'label' : 'Namenaktien', 'font_size' : function(self){return '18'}, 'show' : function(){if(variables['shares'].namen_stamm.value != 0 || variables['shares'].namen_stimm.value != 0 || variables['shares'].namen_vorzug_1.value != 0){return true;}else{return false;}}});

var label = page5.add_label({'label' : 'Stammaktien', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].namen_stamm.value != 0){return true;}else{return false;}}});

var text = page5.add_text({'label' : 'Anzahl Stammaktien', 'variable_name' : 'namenaktien_stammaktien_n', 'show' : function(){if(variables['shares'].namen_stamm.value != 0){return true;}else{return false;}}});
...
var text = page5.add_text({'label' : 'Nominalwert Stammaktien (CHF)', 'variable_name' : 'namenaktien_stammaktien', 'show' : function(){if(variables['shares'].namen_stamm.value != 0){return true;}else{return false;}}});
...
var label = page5.add_label({'label' : 'Vorzugsaktien Kategorie 1', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].namen_vorzug_1.value != 0){return true;}else{return false;}}});

var text = page5.add_text({'label' : 'Anzahl', 'variable_name' : 'namenaktien_vorzugsaktien_kat1_n', 'show' : function(){if(variables['shares'].namen_vorzug_1.value != 0){return true;}else{return false;}}});
...
var text = page5.add_text({'label' : 'Bezeichnung', 'variable_name' : 'namenaktien_vorzugsaktien_kat1_bezeichnung', 'show' : function(){if(variables['shares'].namen_vorzug_1.value != 0){return true;}else{return false;}}});

var text = page5.add_text({'label' : 'Nominalwert (CHF)', 'variable_name' : 'namenaktien_vorzugsaktien_kat1', 'show' : function(){if(variables['shares'].namen_vorzug_1.value != 0){return true;}else{return false;}}});
...
var label = page5.add_label({'label' : 'Vorzugsaktien Kategorie 2', 'font_size' : function(self){return '16'}, 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].namen_vorzug_2.value != 0){return true;}else{return false;}}});

var text = page5.add_text({'label' : 'Anzahl', 'variable_name' : 'namenaktien_vorzugsaktien_kat2_n', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].namen_vorzug_2.value != 0){return true;}else{return false;}}});
...
var text = page5.add_text({'label' : 'Bezeichnung', 'variable_name' : 'namenaktien_vorzugsaktien_kat2_bezeichnung', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].namen_vorzug_2.value != 0){return true;}else{return false;}}});

var text = page5.add_text({'label' : 'Nominalwert (CHF)', 'variable_name' : 'namenaktien_vorzugsaktien_kat2', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].namen_vorzug_2.value != 0){return true;}else{return false;}}});
...
var label = page5.add_label({'label' : 'Vorzugsaktien Kategorie 3', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].namen_vorzug_3.value != 0){return true;}else{return false;}}});

var text = page5.add_text({'label' : 'Anzahl', 'variable_name' : 'namenaktien_vorzugsaktien_kat3_n', 'show' : function(){if(variables['shares'].namen_vorzug_3.value != 0){return true;}else{return false;}}});
...
var text = page5.add_text({'label' : 'Bezeichnung', 'variable_name' : 'namenaktien_vorzugsaktien_kat3_bezeichnung', 'show' : function(){if(variables['shares'].namen_vorzug_3.value != 0){return true;}else{return false;}}});

var text = page5.add_text({'label' : 'Nominalwert (CHF)', 'variable_name' : 'namenaktien_vorzugsaktien_kat3', 'show' : function(){if(variables['shares'].namen_vorzug_3.value != 0){return true;}else{return false;}}});
...
var label = page5.add_label({'label' : 'Stimmrechtsaktien', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].namen_stimm.value != 0){return true;}else{return false;}}});

var text = page5.add_text({'label' : 'Anzahl Stimmrechtsaktien', 'variable_name' : 'namenaktien_stimmrechtsaktien_n', 'show' : function(){if(variables['shares'].namen_stimm.value != 0){return true;}else{return false;}}});
...
var text = page5.add_text({'label' : 'Nominalwert Stimmrechtsaktien (CHF)', 'variable_name' : 'namenaktien_stimmrechtsaktien', 'show' : function(){if(variables['shares'].namen_stimm.value != 0){return true;}else{return false;}}});
...
var separator = page5.add_separator({'show' : function(){if((variables['shares'].namen_stamm.value != 0 || variables['shares'].namen_stimm.value != 0 || variables['shares'].namen_vorzug_1.value != 0 || variables['shares'].namen_vorzug_2.value != 0 || variables['shares'].namen_vorzug_3.value != 0) && (variables['shares'].inhaber_stamm.value != 0 || variables['shares'].inhaber_vorzug_1.value != 0 || variables['shares'].inhaber_vorzug_2.value != 0 || variables['shares'].inhaber_vorzug_3.value != 0)){return true;}else{return false;}}});

var label = page5.add_label({'label' : 'Inhaberaktien', 'font_size' : function(self){return '18'}, 'show' : function(){if(variables['shares'].inhaber_stamm.value != 0 || variables['shares'].inhaber_vorzug_1.value != 0 || variables['shares'].inhaber_vorzug_2.value != 0 || variables['shares'].inhaber_vorzug_3.value != 0){return true;}else{return false;}}});

var label = page5.add_label({'label' : 'Stammaktien', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].inhaber_stamm.value != 0){return true;}else{return false;}}});

var text = page5.add_text({'label' : 'Anzahl Stammaktien', 'variable_name' : 'inhaberaktien_stammaktien_n', 'show' : function(){if(variables['shares'].inhaber_stamm.value != 0){return true;}else{return false;}}});
...
var text = page5.add_text({'label' : 'Nominalwert Stammaktien (CHF)', 'variable_name' : 'inhaberaktien_stammaktien', 'show' : function(){if(variables['shares'].inhaber_stamm.value != 0){return true;}else{return false;}}});
...
var label = page5.add_label({'label' : 'Vorzugsaktien Kategorie 1', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].inhaber_vorzug_1.value != 0){return true;}else{return false;}}});

var text = page5.add_text({'label' : 'Anzahl', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat1_n', 'show' : function(){if(variables['shares'].inhaber_vorzug_1.value != 0){return true;}else{return false;}}});
...
var text = page5.add_text({'label' : 'Bezeichnung', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat1_bezeichnung', 'show' : function(){if(variables['shares'].inhaber_vorzug_1.value != 0){return true;}else{return false;}}});

var text = page5.add_text({'label' : 'Nominalwert (CHF)', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat1', 'show' : function(){if(variables['shares'].inhaber_vorzug_1.value != 0){return true;}else{return false;}}});
...
var label = page5.add_label({'label' : 'Vorzugsaktien Kategorie 2', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].inhaber_vorzug_2.value != 0){return true;}else{return false;}}});

var text = page5.add_text({'label' : 'Anzahl', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat2_n', 'show' : function(){if(variables['shares'].inhaber_vorzug_2.value != 0){return true;}else{return false;}}});
...
var text = page5.add_text({'label' : 'Bezeichnung', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat2_bezeichnung', 'show' : function(){if(variables['shares'].inhaber_vorzug_2.value != 0){return true;}else{return false;}}});

var text = page5.add_text({'label' : 'Nominalwert (CHF)', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat2', 'show' : function(){if(variables['shares'].inhaber_vorzug_2.value != 0){return true;}else{return false;}}});
...
var label = page5.add_label({'label' : 'Vorzugsaktien Kategorie 3', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].inhaber_vorzug_3.value != 0){return true;}else{return false;}}});

var text = page5.add_text({'label' : 'Anzahl', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat3_n', 'show' : function(){if(variables['shares'].inhaber_vorzug_3.value != 0){return true;}else{return false;}}});
...
var text = page5.add_text({'label' : 'Bezeichnung', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat3_bezeichnung', 'show' : function(){if(variables['shares'].inhaber_vorzug_3.value != 0){return true;}else{return false;}}});

var text = page5.add_text({'label' : 'Nominalwert (CHF)', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat3', 'show' : function(){if(variables['shares'].inhaber_vorzug_3.value != 0){return true;}else{return false;}}});
...
var label = page6.add_label({'label' : 'Namenaktien', 'font_size' : function(self){return '18'}, 'show' : function(){if(variables['shares'].namen_stamm.value != 0 || variables['shares'].namen_stimm.value != 0 || variables['shares'].namen_vorzug_1.value != 0){return true;}else{return false;}}});

var label = page6.add_label({'label' : 'Stammaktien', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].namen_stamm.value != 0){return true;}else{return false;}}});

var text = page6.add_text({'label' : 'Anzahl Stammaktien', 'variable_name' : 'namenaktien_stammaktien_n', 'show' : function(){if(variables['shares'].namen_stamm.value != 0){return true;}else{return false;}}});
...
var text = page6.add_text({'label' : 'Nominalwert Stammaktien (CHF)', 'variable_name' : 'namenaktien_stammaktien', 'show' : function(){if(variables['shares'].namen_stamm.value != 0){return true;}else{return false;}}});
...
var label = page6.add_label({'label' : 'Vorzugsaktien Kategorie 1', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].namen_vorzug_1.value != 0){return true;}else{return false;}}});

var text = page6.add_text({'label' : 'Anzahl', 'variable_name' : 'namenaktien_vorzugsaktien_kat1_n', 'show' : function(){if(variables['shares'].namen_vorzug_1.value != 0){return true;}else{return false;}}});
...
var text = page6.add_text({'label' : 'Bezeichnung', 'variable_name' : 'namenaktien_vorzugsaktien_kat1_bezeichnung', 'show' : function(){if(variables['shares'].namen_vorzug_1.value != 0){return true;}else{return false;}}});

var text = page6.add_text({'label' : 'Nominalwert (CHF)', 'variable_name' : 'namenaktien_vorzugsaktien_kat1', 'show' : function(){if(variables['shares'].namen_vorzug_1.value != 0){return true;}else{return false;}}});
...
var label = page6.add_label({'label' : 'Vorzugsaktien Kategorie 2', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].namen_vorzug_2.value != 0){return true;}else{return false;}}});

var text = page6.add_text({'label' : 'Anzahl', 'variable_name' : 'namenaktien_vorzugsaktien_kat2_n', 'show' : function(){if(variables['shares'].namen_vorzug_2.value != 0){return true;}else{return false;}}});
...
var text = page6.add_text({'label' : 'Bezeichnung', 'variable_name' : 'namenaktien_vorzugsaktien_kat2_bezeichnung', 'show' : function(){if(variables['shares'].namen_vorzug_2.value != 0){return true;}else{return false;}}});

var text = page6.add_text({'label' : 'Nominalwert (CHF)', 'variable_name' : 'namenaktien_vorzugsaktien_kat2', 'show' : function(){if(variables['shares'].namen_vorzug_2.value != 0){return true;}else{return false;}}});
...
var label = page6.add_label({'label' : 'Vorzugsaktien Kategorie 3', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].namen_vorzug_3.value != 0){return true;}else{return false;}}});

var text = page6.add_text({'label' : 'Anzahl', 'variable_name' : 'namenaktien_vorzugsaktien_kat3_n', 'show' : function(){if(variables['shares'].namen_vorzug_3.value != 0){return true;}else{return false;}}});
...
var text = page6.add_text({'label' : 'Bezeichnung', 'variable_name' : 'namenaktien_vorzugsaktien_kat3_bezeichnung', 'show' : function(){if(variables['shares'].namen_vorzug_3.value != 0){return true;}else{return false;}}});

var text = page6.add_text({'label' : 'Nominalwert (CHF)', 'variable_name' : 'namenaktien_vorzugsaktien_kat3', 'show' : function(){if(variables['shares'].namen_vorzug_3.value != 0){return true;}else{return false;}}});
...
var label = page6.add_label({'label' : 'Stimmrechtsaktien', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].namen_stimm.value != 0){return true;}else{return false;}}});

var text = page6.add_text({'label' : 'Anzahl Stimmrechtsaktien', 'variable_name' : 'namenaktien_stimmrechtsaktien_n', 'show' : function(){if(variables['shares'].namen_stimm.value != 0){return true;}else{return false;}}});
...
var text = page6.add_text({'label' : 'Nominalwert Stimmrechtsaktien (CHF)', 'variable_name' : 'namenaktien_stimmrechtsaktien', 'show' : function(){if(variables['shares'].namen_stimm.value != 0){return true;}else{return false;}}});
...
var separator = page6.add_separator({'show' : function(){if((variables['shares'].namen_stamm.value != 0 || variables['shares'].namen_stimm.value != 0 || variables['shares'].namen_vorzug_1.value != 0 || variables['shares'].namen_vorzug_2.value != 0 || variables['shares'].namen_vorzug_3.value != 0) && (variables['shares'].inhaber_stamm.value != 0 || variables['shares'].inhaber_vorzug_1.value != 0 || variables['shares'].inhaber_vorzug_2.value != 0 || variables['shares'].inhaber_vorzug_3.value != 0)){return true;}else{return false;}}});

var label = page6.add_label({'label' : 'Inhaberaktien', 'font_size' : function(self){return '18'}, 'show' : function(){if(variables['shares'].inhaber_stamm.value != 0 || variables['shares'].inhaber_vorzug_1.value != 0 || variables['shares'].inhaber_vorzug_2.value != 0 || variables['shares'].inhaber_vorzug_3.value != 0){return true;}else{return false;}}});

var label = page6.add_label({'label' : 'Stammaktien', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].inhaber_stamm.value != 0){return true;}else{return false;}}});

var text = page6.add_text({'label' : 'Anzahl Stammaktien', 'variable_name' : 'inhaberaktien_stammaktien_n', 'show' : function(){if(variables['shares'].inhaber_stamm.value != 0){return true;}else{return false;}}});
...
var text = page6.add_text({'label' : 'Nominalwert Stammaktien (CHF)', 'variable_name' : 'inhaberaktien_stammaktien', 'show' : function(){if(variables['shares'].inhaber_stamm.value != 0){return true;}else{return false;}}});
...
var label = page6.add_label({'label' : 'Vorzugsaktien Kategorie 1', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].inhaber_vorzug_1.value != 0){return true;}else{return false;}}});

var text = page6.add_text({'label' : 'Anzahl', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat1_n', 'show' : function(){if(variables['shares'].inhaber_vorzug_1.value != 0){return true;}else{return false;}}});
...
var text = page6.add_text({'label' : 'Bezeichnung', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat1_bezeichnung', 'show' : function(){if(variables['shares'].inhaber_vorzug_1.value != 0){return true;}else{return false;}}});

var text = page6.add_text({'label' : 'Nominalwert (CHF)', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat1', 'show' : function(){if(variables['shares'].inhaber_vorzug_1.value != 0){return true;}else{return false;}}});
...
var label = page6.add_label({'label' : 'Vorzugsaktien Kategorie 2', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].inhaber_vorzug_2.value != 0){return true;}else{return false;}}});

var text = page6.add_text({'label' : 'Anzahl', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat2_n', 'show' : function(){if(variables['shares'].inhaber_vorzug_2.value != 0){return true;}else{return false;}}});
...
var text = page6.add_text({'label' : 'Bezeichnung', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat2_bezeichnung', 'show' : function(){if(variables['shares'].inhaber_vorzug_2.value != 0){return true;}else{return false;}}});

var text = page6.add_text({'label' : 'Nominalwert (CHF)', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat2', 'show' : function(){if(variables['shares'].inhaber_vorzug_2.value != 0){return true;}else{return false;}}});
...
var label = page6.add_label({'label' : 'Vorzugsaktien Kategorie 3', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].inhaber_vorzug_3.value != 0){return true;}else{return false;}}});

var text = page6.add_text({'label' : 'Anzahl', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat3_n', 'show' : function(){if(variables['shares'].inhaber_vorzug_3.value != 0){return true;}else{return false;}}});
...
var text = page6.add_text({'label' : 'Bezeichnung', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat3_bezeichnung', 'show' : function(){if(variables['shares'].inhaber_vorzug_3.value != 0){return true;}else{return false;}}});

var text = page6.add_text({'label' : 'Nominalwert (CHF)', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat3', 'show' : function(){if(variables['shares'].inhaber_vorzug_3.value != 0){return true;}else{return false;}}});
...
var checkbox_group = page1.add_checkbox_group({'label' : ''});
var checkbox = checkbox_group.add_checkbox({'label' : 'Déchargeerteilung an Revisionsstelle', 'variable_name' : 'decharge'});
...
var text = page0.add_text({'label' : 'Artikel Nr.', 'variable_name' : 'artikel_nr', 'required' : true});

var separator = page0.add_separator({});

var checkbox_group = page0.add_checkbox_group({'label' : ''});
var checkbox = checkbox_group.add_checkbox({'label' : 'Absatz', 'variable_name' : 'absatz'});

var text = page0.add_text({'label' : 'Von Absatz Nr.', 'variable_name' : 'absatz_nr_begin', 'required' : true, 'show' : function(){if(equals(['verhandlungen', 'anderung', 'absatz'], true)){return true;}else{return false;}}});

var text = page0.add_text({'label' : 'Bis Absatz Nr.', 'variable_name' : 'absatz_nr_end', 'required' : true, 'show' : function(){if(equals(['verhandlungen', 'anderung', 'absatz'], true)){return true;}else{return false;}}});

var separator = page0.add_separator({});

var text = page0.add_text({'label' : 'Der Titel des betreffenden Artikel (bzw. Absatz) lautet (neu) wie folgt (Deutsch):', 'variable_name' : 'titel_de', 'required' : true});

var text = page0.add_text({'label' : 'Der Titel des betreffenden Artikel (bzw. Absatz) lautet (neu) wie folgt (Englisch):', 'variable_name' : 'titel_en', 'required' : true});

var text = page0.add_textarea({'label' : 'Der betreffende Artikel (bzw. Absatz) lautet neu wie folgt (Deutsch):', 'variable_name' : 'name_de', 'required' : true});

var text = page0.add_textarea({'label' : 'Der betreffende Artikel (bzw. Absatz) lautet neu wie folgt (Englisch):', 'variable_name' : 'name_en', 'required' : true});
...
var checkbox_group = page1.add_checkbox_group({'label' : 'Dank', 'show' : function(){return equals(['verhandlungen', 'verhandlungen', 'abberufung'], 'sofort')}});
var checkbox = checkbox_group.add_checkbox({'label' : 'Das Aktionariat dankt der Revisionsstelle für Ihren Einsatz', 'variable_name' : 'dank'});
...
var label = page1.add_label({'label' : 'Datum der Vollmacht', 'font_size' : function(self){return '20'}});

var text = page1.add_text({'label' : 'Datum', 'variable_name' : 'datum_de', 'required' : true, 'date' : true});

form.add_derived_variable({'condition' : function(v){if(v[0] == 'vollmacht' && v[1] == 'vollmacht' && v[2] == 'datum_de'){return true}else{return false}}, 'assignment' : function(v){variables[v[0]][v[1]]['datum_en'] = convert_date(variables[v[0]][v[1]][v[2]])}});
...
var radio = page1.add_radio({'variable_name' : 'sex_b', 'required' : true});
var option = radio.add_option({'value' : 'herr',  'label' : 'Herr'});
var option = radio.add_option({'value' : 'frau', 'label' : 'Frau'});

var text = page1.add_text({'label' : 'Vorname', 'variable_name' : 'vorname_b', 'required' : true});

var text = page1.add_text({'label' : 'Name', 'variable_name' : 'nachname_b', 'required' : true});
var text = page1.add_text({'label' : 'Titel (Deutsch)', 'variable_name' : 'titel_de_b', 'placeholder' : 'Optional'});
var text = page1.add_text({'label' : 'Titel (English)', 'variable_name' : 'titel_en_b', 'placeholder' : 'Optional'});
var text = page1.add_text({'label' : 'Strasse und Hausnummer', 'variable_name' : 'strasse_b', 'required' : true});
var text = page1.add_text({'label' : 'Ort (Deutsch)', 'variable_name' : 'ort_de_b', 'required' : true});
var text = page1.add_text({'label' : 'Ort (Englisch)', 'variable_name' : 'ort_en_b', 'required' : true});

var text = page1.add_text({'label' : 'Land (Deutsch)', 'variable_name' : 'land_de_b', 'required' : true});
var text = page1.add_text({'label' : 'Land (Englisch)', 'variable_name' : 'land_en_b', 'required' : true});
...
var label = page1.add_label({'label' : 'Namenaktien', 'font_size' : function(self){return '18'}, 'show' : function(){if(variables['shares'].namen_stamm.value != 0 || variables['shares'].namen_stimm.value != 0 || variables['shares'].namen_vorzug_1.value != 0){return true;}else{return false;}}});

var label = page1.add_label({'label' : 'Stammaktien', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].namen_stamm.value != 0){return true;}else{return false;}}});

var text = page1.add_text({'label' : 'Anzahl Stammaktien', 'variable_name' : 'namenaktien_stammaktien_n', 'show' : function(){if(variables['shares'].namen_stamm.value != 0){return true;}else{return false;}}});
form.add_derived_variable({'condition' : function(v){if(v[0] == 'vollmacht' && v[1] == 'vollmacht' && v[3] == 'namenaktien_stammaktien_n'){return true}else{return false}}, 'assignment' : function(v){
    variables[v[0]][v[1]][v[2]][v[3]] = parseInt(variables[v[0]][v[1]][v[2]][v[3]].replace(/[^0-9]/, ''));variables[v[0]][v[1]][v[2]]['namenaktien_stammaktien'] = (parseFloat(variables[v[0]][v[1]][v[2]][v[3]]) * variables['shares'].namen_stamm.value).toFixed(2);}});

var text = page1.add_text({'label' : 'Nominalwert Stammaktien (CHF)', 'variable_name' : 'namenaktien_stammaktien', 'show' : function(){if(variables['shares'].namen_stamm.value != 0){return true;}else{return false;}}});
...
var label = page1.add_label({'label' : 'Vorzugsaktien Kategorie 1', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].namen_vorzug_1.value != 0){return true;}else{return false;}}});

var text = page1.add_text({'label' : 'Anzahl', 'variable_name' : 'namenaktien_vorzugsaktien_kat1_n', 'show' : function(){if(variables['shares'].namen_vorzug_1.value != 0){return true;}else{return false;}}});
form.add_derived_variable({'condition' : function(v){if(v[0] == 'vollmacht' && v[1] == 'vollmacht' && v[3] == 'namenaktien_vorzugsaktien_kat1_n'){return true}else{return false}}, 'assignment' : function(v){
    variables[v[0]][v[1]][v[2]][v[3]] = parseInt(variables[v[0]][v[1]][v[2]][v[3]].replace(/[^0-9]/, ''));variables[v[0]][v[1]][v[2]]['namenaktien_vorzugsaktien_kat1'] = (parseFloat(variables[v[0]][v[1]][v[2]][v[3]]) * variables['shares'].namen_vorzug_1.value).toFixed(2);}});

var text = page1.add_text({'label' : 'Bezeichnung', 'variable_name' : 'namenaktien_vorzugsaktien_kat1_bezeichnung', 'show' : function(){if(variables['shares'].namen_vorzug_1.value != 0){return true;}else{return false;}}});

var text = page1.add_text({'label' : 'Nominalwert (CHF)', 'variable_name' : 'namenaktien_vorzugsaktien_kat1', 'show' : function(){if(variables['shares'].namen_vorzug_1.value != 0){return true;}else{return false;}}});
...
var label = page1.add_label({'label' : 'Vorzugsaktien Kategorie 2', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].namen_vorzug_2.value != 0){return true;}else{return false;}}});

var text = page1.add_text({'label' : 'Anzahl', 'variable_name' : 'namenaktien_vorzugsaktien_kat2_n', 'show' : function(){if(variables['shares'].namen_vorzug_2.value != 0){return true;}else{return false;}}});
form.add_derived_variable({'condition' : function(v){if(v[0] == 'vollmacht' && v[1] == 'vollmacht' && v[3] == 'namenaktien_vorzugsaktien_kat2_n'){return true}else{return false}}, 'assignment' : function(v){
    variables[v[0]][v[1]][v[2]][v[3]] = parseInt(variables[v[0]][v[1]][v[2]][v[3]].replace(/[^0-9]/, ''));variables[v[0]][v[1]][v[2]]['namenaktien_vorzugsaktien_kat2'] = (parseFloat(variables[v[0]][v[1]][v[2]][v[3]]) * variables['shares'].namen_vorzug_2.value).toFixed(2);}});

var text = page1.add_text({'label' : 'Bezeichnung', 'variable_name' : 'namenaktien_vorzugsaktien_kat2_bezeichnung', 'show' : function(){if(variables['shares'].namen_vorzug_2.value != 0){return true;}else{return false;}}});

var text = page1.add_text({'label' : 'Nominalwert (CHF)', 'variable_name' : 'namenaktien_vorzugsaktien_kat2', 'show' : function(){if(variables['shares'].namen_vorzug_2.value != 0){return true;}else{return false;}}});
...
var label = page1.add_label({'label' : 'Vorzugsaktien Kategorie 3', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].namen_vorzug_3.value != 0){return true;}else{return false;}}});

var text = page1.add_text({'label' : 'Anzahl', 'variable_name' : 'namenaktien_vorzugsaktien_kat3_n', 'show' : function(){if(variables['shares'].namen_vorzug_3.value != 0){return true;}else{return false;}}});
form.add_derived_variable({'condition' : function(v){if(v[0] == 'vollmacht' && v[1] == 'vollmacht' && v[3] == 'namenaktien_vorzugsaktien_kat3_n'){return true}else{return false}}, 'assignment' : function(v){
    variables[v[0]][v[1]][v[2]][v[3]] = parseInt(variables[v[0]][v[1]][v[2]][v[3]].replace(/[^0-9]/, ''));variables[v[0]][v[1]][v[2]]['namenaktien_vorzugsaktien_kat3'] = (parseFloat(variables[v[0]][v[1]][v[2]][v[3]]) * variables['shares'].namen_vorzug_3.value).toFixed(2);}});

var text = page1.add_text({'label' : 'Bezeichnung', 'variable_name' : 'namenaktien_vorzugsaktien_kat3_bezeichnung', 'show' : function(){if(variables['shares'].namen_vorzug_3.value != 0){return true;}else{return false;}}});

var text = page1.add_text({'label' : 'Nominalwert (CHF)', 'variable_name' : 'namenaktien_vorzugsaktien_kat3', 'show' : function(){if(variables['shares'].namen_vorzug_3.value != 0){return true;}else{return false;}}});
...
var label = page1.add_label({'label' : 'Stimmrechtsaktien', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].namen_stimm.value != 0){return true;}else{return false;}}});

var text = page1.add_text({'label' : 'Anzahl Stimmrechtsaktien', 'variable_name' : 'namenaktien_stimmrechtsaktien_n', 'show' : function(){if(variables['shares'].namen_stimm.value != 0){return true;}else{return false;}}});
form.add_derived_variable({'condition' : function(v){if(v[0] == 'vollmacht' && v[1] == 'vollmacht' && v[3] == 'namenaktien_stimmrechtsaktien_n'){return true}else{return false}}, 'assignment' : function(v){
    variables[v[0]][v[1]][v[2]][v[3]] = parseInt(variables[v[0]][v[1]][v[2]][v[3]].replace(/[^0-9]/, ''));variables[v[0]][v[1]][v[2]]['namenaktien_stimmrechtsaktien'] = (parseFloat(variables[v[0]][v[1]][v[2]][v[3]]) * variables['shares'].namen_stimm.value).toFixed(2);}});

var text = page1.add_text({'label' : 'Nominalwert Stimmrechtsaktien (CHF)', 'variable_name' : 'namenaktien_stimmrechtsaktien', 'show' : function(){if(variables['shares'].namen_stimm.value != 0){return true;}else{return false;}}});
...
var separator = page1.add_separator({'show' : function(){if((variables['shares'].namen_stamm.value != 0 || variables['shares'].namen_stimm.value != 0 || variables['shares'].namen_vorzug_1.value != 0 || variables['shares'].namen_vorzug_2.value != 0 || variables['shares'].namen_vorzug_3.value != 0) && (variables['shares'].inhaber_stamm.value != 0 || variables['shares'].inhaber_vorzug_1.value != 0 || variables['shares'].inhaber_vorzug_2.value != 0 || variables['shares'].inhaber_vorzug_3.value != 0)){return true;}else{return false;}}});

var label = page1.add_label({'label' : 'Inhaberaktien', 'font_size' : function(self){return '18'}, 'show' : function(){if(variables['shares'].inhaber_stamm.value != 0 || variables['shares'].inhaber_vorzug_1.value != 0 || variables['shares'].inhaber_vorzug_2.value != 0 || variables['shares'].inhaber_vorzug_3.value != 0){return true;}else{return false;}}});

var label = page1.add_label({'label' : 'Stammaktien', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].inhaber_stamm.value != 0){return true;}else{return false;}}});

var text = page1.add_text({'label' : 'Anzahl Stammaktien', 'variable_name' : 'inhaberaktien_stammaktien_n', 'show' : function(){if(variables['shares'].inhaber_stamm.value != 0){return true;}else{return false;}}});
form.add_derived_variable({'condition' : function(v){if(v[0] == 'vollmacht' && v[1] == 'vollmacht' && v[3] == 'inhaberaktien_stammaktien_n'){return true}else{return false}}, 'assignment' : function(v){
    variables[v[0]][v[1]][v[2]][v[3]] = parseInt(variables[v[0]][v[1]][v[2]][v[3]].replace(/[^0-9]/, ''));variables[v[0]][v[1]][v[2]]['inhaberaktien_stammaktien'] = (parseFloat(variables[v[0]][v[1]][v[2]][v[3]]) * variables['shares'].inhaber_stamm.value).toFixed(2);}});

var text = page1.add_text({'label' : 'Nominalwert Stammaktien (CHF)', 'variable_name' : 'inhaberaktien_stammaktien', 'show' : function(){if(variables['shares'].inhaber_stamm.value != 0){return true;}else{return false;}}});
...
var label = page1.add_label({'label' : 'Vorzugsaktien Kategorie 1', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].inhaber_vorzug_1.value != 0){return true;}else{return false;}}});

var text = page1.add_text({'label' : 'Anzahl', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat1_n', 'show' : function(){if(variables['shares'].inhaber_vorzug_1.value != 0){return true;}else{return false;}}});
form.add_derived_variable({'condition' : function(v){if(v[0] == 'vollmacht' && v[1] == 'vollmacht' && v[3] == 'inhaberaktien_vorzugsaktien_kat1_n'){return true}else{return false}}, 'assignment' : function(v){
    variables[v[0]][v[1]][v[2]][v[3]] = parseInt(variables[v[0]][v[1]][v[2]][v[3]].replace(/[^0-9]/, ''));variables[v[0]][v[1]][v[2]]['inhaberaktien_vorzugsaktien_kat1'] = (parseFloat(variables[v[0]][v[1]][v[2]][v[3]]) * variables['shares'].inhaber_vorzug_1.value).toFixed(2);}});

var text = page1.add_text({'label' : 'Bezeichnung', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat1_bezeichnung', 'show' : function(){if(variables['shares'].inhaber_vorzug_1.value != 0){return true;}else{return false;}}});

var text = page1.add_text({'label' : 'Nominalwert (CHF)', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat1', 'show' : function(){if(variables['shares'].inhaber_vorzug_1.value != 0){return true;}else{return false;}}});
...
var label = page1.add_label({'label' : 'Vorzugsaktien Kategorie 2', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].inhaber_vorzug_2.value != 0){return true;}else{return false;}}});

var text = page1.add_text({'label' : 'Anzahl', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat2_n', 'show' : function(){if(variables['shares'].inhaber_vorzug_2.value != 0){return true;}else{return false;}}});
form.add_derived_variable({'condition' : function(v){if(v[0] == 'vollmacht' && v[1] == 'vollmacht' && v[3] == 'inhaberaktien_vorzugsaktien_kat2_n'){return true}else{return false}}, 'assignment' : function(v){
    variables[v[0]][v[1]][v[2]][v[3]] = parseInt(variables[v[0]][v[1]][v[2]][v[3]].replace(/[^0-9]/, ''));variables[v[0]][v[1]][v[2]]['inhaberaktien_vorzugsaktien_kat2'] = (parseFloat(variables[v[0]][v[1]][v[2]][v[3]]) * variables['shares'].inhaber_vorzug_2.value).toFixed(2);}});

var text = page1.add_text({'label' : 'Bezeichnung', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat2_bezeichnung', 'show' : function(){if(variables['shares'].inhaber_vorzug_2.value != 0){return true;}else{return false;}}});

var text = page1.add_text({'label' : 'Nominalwert (CHF)', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat2', 'show' : function(){if(variables['shares'].inhaber_vorzug_2.value != 0){return true;}else{return false;}}});
...
var label = page1.add_label({'label' : 'Vorzugsaktien Kategorie 3', 'font_size' : function(self){return '16'}, 'show' : function(){if(variables['shares'].inhaber_vorzug_3.value != 0){return true;}else{return false;}}});

var text = page1.add_text({'label' : 'Anzahl', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat3_n', 'show' : function(){if(variables['shares'].inhaber_vorzug_3.value != 0){return true;}else{return false;}}});
form.add_derived_variable({'condition' : function(v){if(v[0] == 'vollmacht' && v[1] == 'vollmacht' && v[3] == 'inhaberaktien_vorzugsaktien_kat3_n'){return true}else{return false}}, 'assignment' : function(v){
    variables[v[0]][v[1]][v[2]][v[3]] = parseInt(variables[v[0]][v[1]][v[2]][v[3]].replace(/[^0-9]/, ''));variables[v[0]][v[1]][v[2]]['inhaberaktien_vorzugsaktien_kat3'] = (parseFloat(variables[v[0]][v[1]][v[2]][v[3]]) * variables['shares'].inhaber_vorzug_3.value).toFixed(2);}});

var text = page1.add_text({'label' : 'Bezeichnung', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat3_bezeichnung', 'show' : function(){if(variables['shares'].inhaber_vorzug_3.value != 0){return true;}else{return false;}}});

var text = page1.add_text({'label' : 'Nominalwert (CHF)', 'variable_name' : 'inhaberaktien_vorzugsaktien_kat3', 'show' : function(){if(variables['shares'].inhaber_vorzug_3.value != 0){return true;}else{return false;}}});
...
form.add_derived_variable({'condition' : function(v){if(v[0] == 'vollmacht' && v[1] == 'vollmacht'){return true}else{return false}}, 'assignment' : function(v){var total_shares = 0;
    if(typeof variables[v[0]][v[1]][v[2]]['namenaktien_stammaktien_n'] != 'undefined'){
        total_shares = total_shares + variables[v[0]][v[1]][v[2]]['namenaktien_stammaktien_n'];
    }
    if(typeof variables[v[0]][v[1]][v[2]]['namenaktien_vorzugsaktien_kat1_n'] != 'undefined'){
        total_shares = total_shares + variables[v[0]][v[1]][v[2]]['namenaktien_vorzugsaktien_kat1_n'];
    }
    if(typeof variables[v[0]][v[1]][v[2]]['namenaktien_vorzugsaktien_kat2_n'] != 'undefined'){
        total_shares = total_shares + variables[v[0]][v[1]][v[2]]['namenaktien_vorzugsaktien_kat2_n'];
    }
    if(typeof variables[v[0]][v[1]][v[2]]['namenaktien_vorzugsaktien_kat3_n'] != 'undefined'){
        total_shares = total_shares + variables[v[0]][v[1]][v[2]]['namenaktien_vorzugsaktien_kat3_n'];
    }
    if(typeof variables[v[0]][v[1]][v[2]]['namenaktien_stimmrechtsaktien_n'] != 'undefined'){
        total_shares = total_shares + variables[v[0]][v[1]][v[2]]['namenaktien_stimmrechtsaktien_n'];
    }
    if(typeof variables[v[0]][v[1]][v[2]]['inhaberaktien_stammaktien_n'] != 'undefined'){
        total_shares = total_shares + variables[v[0]][v[1]][v[2]]['inhaberaktien_stammaktien_n'];
    }
    if(typeof variables[v[0]][v[1]][v[2]]['inhaberaktien_vorzugsaktien_kat1_n'] != 'undefined'){
        total_shares = total_shares + variables[v[0]][v[1]][v[2]]['inhaberaktien_vorzugsaktien_kat1_n'];
    }
    if(typeof variables[v[0]][v[1]][v[2]]['inhaberaktien_vorzugsaktien_kat2_n'] != 'undefined'){
        total_shares = total_shares + variables[v[0]][v[1]][v[2]]['inhaberaktien_vorzugsaktien_kat2_n'];
    }
    if(typeof variables[v[0]][v[1]][v[2]]['inhaberaktien_vorzugsaktien_kat2_n'] != 'undefined'){
        total_shares = total_shares + variables[v[0]][v[1]][v[2]]['inhaberaktien_vorzugsaktien_kat2_n'];
    }
    variables[v[0]][v[1]][v[2]]['total_shares'] = total_shares;

    }});

var separator = page1.add_separator({'show' : function(self, index){return equals(['vollmacht', 'vollmacht', index, 'aussteller'], 'unternehmung');}});

var checkbox_group = page1.add_checkbox_group({'label' : ''});
var checkbox = checkbox_group.add_checkbox({'label' : function(self, index){if(equals(['vollmacht', 'vollmacht', index, 'sex'],'frau')){return 'Bevollmächtigte ist Organ der Gesellschaft oder eine andere von der Gesellschaft abhängige Person'}else{return 'Bevollmächtigter ist Organ der Gesellschaft oder eine andere von der Gesellschaft abhängige Person'}}, 'variable_name' : 'organ', 'show' : function(self, index){return equals(['vollmacht', 'vollmacht', index, 'aussteller'], 'unternehmung');}});
